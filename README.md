...
[index.html](index.html) — 單頁 11 章手冊：品牌理念、Logo、色彩、字體、輔助圖形、應用範例、Tone of Voice、漸層、圖示、動態設計、素材下載。
...
- **色票**：Moss `#354238` · Mist `#EBEBEB` · Amethyst `#9E91B2` · Stone `#BEB6A6`
- **字體**：Noto Serif TC ＋ Noto Sans TC ＋ EB Garamond ＋ Inter（全 Google Fonts · SIL OFL）
